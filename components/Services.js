...
const Services = () => {
    return (
        <>
            ...
            <div className='flex justify-around items-center border my-12'>
                <div className='flex gap-y-2 flex-col justify-center items-center w-[90vw] sm:w-[45vw] lg:w-[30vw] p-5 rounded-2xl border border-[#0096c7]'>
